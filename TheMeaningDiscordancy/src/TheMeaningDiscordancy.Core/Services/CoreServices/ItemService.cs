...
public class ItemService : BaseDiscordService<ItemDto, ItemEfc>, IItemService
{
    ...
    public Task<DiscordResult<ItemEfc>> DeleteItemAsync(int id)
    {
        throw new NotImplementedException();
    }

    public Task<DiscordResult<List<ItemEfc>>> GetAllItemsAsync()
    {
        throw new NotImplementedException();
    }

    public Task<DiscordResult<ItemEfc>> GetItemAsync(int id)
    {
        throw new NotImplementedException();
    }

    public Task<DiscordResult<ItemEfc>> UpdateItemAsync(ItemDto inputDto, int id)
    {
        throw new NotImplementedException();
    }
